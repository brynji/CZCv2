...
public class BuyerClient {
    ...
    public Optional<Buyer> getOne(){
        try{
            return Optional.of(currentBuyerRestClient.get().retrieve().toEntity(Buyer.class).getBody());
    ...
    public Collection<Buyer> getAll(){
        var res = buyerRestClient.get().accept(MediaType.APPLICATION_JSON).retrieve().toEntity(Buyer[].class).getBody();
